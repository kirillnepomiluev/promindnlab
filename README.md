...
Каждый запрос к боту списывает токены с баланса пользователя. Стоимость зависит от типа запроса:

- текстовый запрос — 1 токен;
- голосовой запрос — 2 токена;
- генерация изображения — 5 токенов.

Баланс можно пополнить командой `/topup <количество>` прямо в Telegram.
